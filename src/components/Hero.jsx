...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="absolute top-10 left-4 sm:left-10 w-65 sm:w-72 h-65 sm:h-72 h-48 sm:h-72 bg-blue-500/10 rounded-full blur-3xl animate-pulse duration-4000 delay-1500"/>
            <div className="absolute bottom-20 right-4 sm-right-10 w-64 sm-w-96 h-64 sm:w-96 h-64 sm:h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse duration-4000"/>

            <div className="max-width-7xl mx-auto text-center relative w-full">
                <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative">
                    <div>
                        <div className="inline-flex items-center space-x-2 p-2 sm:p-3 bg-blue-500/10 border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-800">
                        ...
                        <h1 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700 delay-100 leading-tight">
                            <span className="bg-gradient-to-r from-white via-blue-150 to-cyan-200 bg-clip-text text-transparent block mb-1 sm:mb-2">
                                Code Faster
                            </span>
                            <span className="bg-gradient-to-b from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent block mb-1 sm:mb-2">
                                Build Better
                            </span>
                            <span className="bg-gradient-to-l from-white via-blue-150 to-cyan-200 bg-clip-text text-transparent block mb-1 sm:mb-2">
                                With CodeFlow AI
                            </span>
                        </h1>
                    ...
                    <div className="relative order-2 w-full">
                        <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
                            <div className="bg-gradient-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[280px] sm:w-[350px] lg:h-[450px] border border-white/5">
                                ...
                                <div className="p-3 sm:p-4 relative h-full">
                                    ...
                                    <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                                        ...
                                        <button className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg ${
                                            activeTab === "App.jsx" 
                                            ? "bg-blue-500/30 text-white border-blue-400/20" 
                                            : "border bg-white/5 text-gray-300 border-white/10 hover:bg-white/10"
                            ...
                            {/* floating cards */}
                            <div className={`hidden lg:block absolute bottom-4 right-4 transform translate-x-8 translate-y-8 w-72 ${floatingCards[activeTab].bgColor} backdrop-blur-sm rounded-lg p-4 border border-white/20 shadow-2xl`}>
